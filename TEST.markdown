...
[Text::ASCIIMathML](http://search.cpan.org/~nodine/Text-ASCIIMathML/) Perl
...
[Supporting MathML](http://fletcherpenney.net/2008/08/supporting_mathml) on my web
site.
...
* <http://fletcherpenney.net/multimarkdown/xslt_files/> - this is where I will
  place various user submitted files that may be of interest, or offer a
  starting point for further customization. Please consider submitting your
  own improvements here as well.
...
[Platypus]: http://www.sveinbjorn.org/platypus "Platypus Homepage"
